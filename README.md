...
> * **El beneficio (Parte izquierda):** Suma los cargos mensuales de las bajas reales que logramos salvar ($_ \text{Cargos}_{TP} _$), multiplicados por la probabilidad de que acepten la oferta ($_ P_{\text{éxito}} _$) e ingresando ese dinero con el descuento ya aplicado $(1 - \text{desc})$.
> * **El coste (Parte derecha):** Resta el "dinero regalado" a los clientes que el modelo marcó como bajas por error pero que en realidad eran fieles ($_ \text{Cargos}_{FP} _$), multiplicado por el descuento que les dimos $(\text{desc})$.
